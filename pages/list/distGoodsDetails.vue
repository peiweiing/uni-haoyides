		...
		<view class="tui-pro-detail">
			<view class="tui-product-title tui-border-radius">
				...
				<view class="tui-padding">
					<view class="tui-sub-title tui-size tui-gray">大佑生宝小分子海参饮品 0脂肪 低糖 增强营养滋补品</view>
			...
			<view class="tui-product-img tui-radius-all">
				<!-- <image :src="'https://www.thorui.cn/img/detail/' + (index + 1) + '.jpg'" v-for="(img, index) in 20" :key="index"
				 mode="widthFix"></image> -->
				 <image src="../../static/img/details.jpg" mode="widthFix"></image>
			</view>
